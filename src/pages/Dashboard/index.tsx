...
const Dashboard: React.FC = () => {
  ...
  const [appointments, setAppointments] = useState<Appintment[]>([]);
  ...
  const handldeMonthChange = useCallback((month: Date) => {
  ...
  useEffect(() => {
    api
      .get<Appintment[]>('/appointments/me', {
        params: {
      ...
      <Content>
        ...
        <Calendar>
          <DayPiker
            ...
            onMonthChange={handldeMonthChange}
